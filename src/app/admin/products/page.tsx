    ...
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div>
        ...
        <div className="mt-2 p-3 bg-blue-50 border border-blue-200 rounded-lg text-xs text-blue-800">
          <p className="font-semibold mb-1">📸 Upload images to imgur.com/upload first</p>
          <p>Right-click each uploaded image → "Copy image address" → Paste here</p>
          <p className="mt-1 opacity-75">First image = main product image. Add 3-5 images for best results.</p>
        </div>
      </div>
            ...
            <CardContent className="p-6">
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-blue-900 mb-2">📸 How to Upload Product Images</h3>
                  <div className="text-sm text-blue-800 space-y-2">
                    <p><strong>Step 1:</strong> Go to <a href="https://imgur.com/upload" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-600">imgur.com/upload</a> and upload your product photos</p>
                    <p><strong>Step 2:</strong> Right-click each image → "Copy image address" (URL will look like: https://i.imgur.com/ABC123.jpg)</p>
                    <p><strong>Step 3:</strong> Click "Add Product" above and paste URLs in the "Images" field (one per line)</p>
                    <p className="text-xs mt-3 opacity-75">💡 <strong>Tip:</strong> Upload 3-5 images per product for best results. See QUICK_IMAGE_UPLOAD_GUIDE.md for details.</p>
                  </div>
                </div>
              </div>
            </CardContent>
